...
<body>
  ...
  <main class="main">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Add Techer</h5>
    ...
    <<!-- Data tables -->
      ...
      <div class="mt-5 py-5">
        <div class="card p-4">
          <h1 class="col-md-12 text-center text-dark">TEACHER TABLE</h1>
          ...
          <div class="container col-12">
            <table id="dataTables" class="data-table">
              <thead>
                <?php
                $tableName = 'teacher';
                $sql1 = "SHOW COLUMNS FROM $tableName WHERE Field != 't_pwd'";
                $sql2 = "SELECT T_ID,T_FNAME,T_LNAME,QUALIFICATION,SALARY,PHONE_NO FROM $tableName";
