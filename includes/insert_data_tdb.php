<?php
    ...
    if (isset($_POST['Add'])){
        ...
        if ($tableName == 'student' || $tableName == 'teacher') {
            ...
            header("Location: ../teacherdashboard/add_$tableName.php");
        }
        if ($query_run){
            $_SESSION['status'] = "User added successfully!";
            header("Location: ../teacherdashboard/add_$tableName.php?add=$inserted_id");
        }else{
    ...
    if (isset($_POST['Update'])){
        ...
        if ($query_run){
            ...
            header("Location: ../teacherdashboard/add_$tableName.php?update=$value_id");
        }
        else{
    ...
    if (isset($_POST['Delete'])){
        ...
        if ($query_run){
            ...
            header("Location: ../teacherdashboard/add_$tableName.php?delete=$value_id");
        }
        else{
