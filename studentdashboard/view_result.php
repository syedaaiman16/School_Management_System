                        ...
                        <div class="table-responsive">
                            <table id="dataTables" class="table table-hover responsive nowrap align-middle mb-0 table table-borderless table-striped table-hover" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT exam.*, COUNT(exam.E_MARKS) as total_sub,SUM(exam.E_MARKS) as total, student.* FROM exam JOIN student on student.S_ID = (SELECT exam.S_ID where exam.S_ID='$student_id') GROUP BY exam.S_ID";
                                    $res = $conn->query($sql);
