<?php
session_start();
if (!empty($_SESSION['user_stat']) && $_SESSION['user_stat'] === 'admin') {
	header("Location: ../admindashboard/index.php");
} else if (!empty($_SESSION['user_stat']) && $_SESSION['user_stat'] === 'student') {
	header("Location: ../studentdashboard/index.php");
} else if (!empty($_SESSION['user_stat']) && $_SESSION['user_stat'] === 'teacher') {
	header("Location: ../teacherdashboard/index.php");
} else {
	session_destroy();
}
...
?>
	...
	<head>
		<meta charset="UTF-8">
		<link rel="stylesheet" href="styleskool.css">
